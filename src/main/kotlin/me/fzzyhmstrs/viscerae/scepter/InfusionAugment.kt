...
class InfusionAugment(tier: Int, maxLvl: Int, vararg slot: EquipmentSlot): MinorSupportAugment(tier, maxLvl, *slot){

    override val baseEffect: AugmentEffect
        get() = super.baseEffect.withDamage(0.8F,0.2F,0.0F)
    ...
    override fun augmentStat(imbueLevel: Int): AugmentDatapoint {
        return AugmentDatapoint(SpellType.GRACE,13,4,1,imbueLevel,LoreTier.LOW_TIER, Items.GLISTERING_MELON_SLICE)
    }
}
