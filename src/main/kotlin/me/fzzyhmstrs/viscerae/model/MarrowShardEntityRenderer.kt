...
class MarrowShardEntityRenderer(context: EntityRendererFactory.Context): ProjectileEntityRenderer<MarrowShardEntity>(context) {
    private val TEXTURE = Identifier(Viscerae.MOD_ID,"textures/entity/marrow_shard.png")

    override fun getTexture(entity: MarrowShardEntity): Identifier {
        return TEXTURE
    }

    override fun render(
        persistentProjectileEntity: MarrowShardEntity,
        f: Float,
        g: Float,
